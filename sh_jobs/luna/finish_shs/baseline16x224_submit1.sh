...
#SBATCH --output=sbatch_log/baseline_nndet16x224_s1_%j.out
#SBATCH --nodes=1
...
# nndet_train 016 -o exp.fold=2 train=v001 +augment_cfg.patch_size=[16,224,224] train.mode=resume --sweep
# nndet_eval 016 RetinaUNetV001_D3V001_3d 2 --boxes --analyze_boxes --shape=16_224_224


echo "Job ID: $SLURM_JOBID"
echo "Time: $(date)"
# nndet_train 016 -o exp.fold=2 train=v001 +augment_cfg.patch_size=[16,224,224] --sweep

nndet_train 016 -o exp.fold=2 train=v001 train.mode=resume +augment_cfg.patch_size=[16,224,224] --sweep
nndet_train 016 -o exp.fold=3 train=v001 train.mode=resume +augment_cfg.patch_size=[16,224,224] --sweep
