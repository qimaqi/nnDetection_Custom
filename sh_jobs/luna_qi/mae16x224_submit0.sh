...
#SBATCH --output=sbatch_log/luna_crop_mae_16x224_s0_%j.out
#SBATCH --nodes=1
...
# nndet_train 017 -o exp.fold=0 train=mae_plain train.mode=resume +augment_cfg.patch_size=[16,224,224]  trainer_cfg.gradient_clip_val=0  trainer_cfg.max_num_epochs=60 trainer_cfg.swa_epochs=0 trainer_cfg.warm_iterations=4000  trainer_cfg.gradient_clip_val=0 trainer_cfg.amp_backend=None trainer_cfg.precision=32 trainer_cfg.amp_level=None +debug.num_cases_val=10 --sweep
